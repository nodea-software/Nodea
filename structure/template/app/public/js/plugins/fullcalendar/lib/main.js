...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function computeFgSegPlacements$1(segs, timelineCoords, eventInstanceHeights, moreLinkHeights, minWidth, isRtl, strictOrder, maxStackCnt) {
        var segInputs = [];
    ...
    var TimelineLane = /** @class */ (function (_super) {
        ...
        function TimelineLane() {
            ...
            _this.sortEventSegs = memoize(sortEventSegs);
            _this.computeFgSegPlacements = memoize(computeFgSegPlacements$1);
        ...
        TimelineLane.prototype.render = function () {
            ...
            return (createElement(Fragment, null,
                ...
                createElement("div", { className: "fc-timeline-events fc-scrollgrid-sync-inner", ref: this.innerElRef, style: { height: fgHeight } },
                    ...
                    this.renderFgSegs(buildMirrorPlacements$1(mirrorSegs, props.timelineCoords, fgPlacements), {}, Boolean(slicedProps.eventDrag), Boolean(slicedProps.eventResize), false))));
        };
    ...
    function buildMirrorPlacements$1(mirrorSegs, timelineCoords, fgPlacements) {
        if (!mirrorSegs.length || !timelineCoords) {
            return [];
        }
        var topsByInstanceId = buildAbsoluteTopHash$1(fgPlacements); // TODO: cache this at first render?
    ...
    function buildAbsoluteTopHash$1(placements) {
        var topsByInstanceId = {};
