...
class Synchronization extends ApiRoute {
	constructor() {
		const routes = ['situation', 'file_upload'];
		super(routes);
	}
	...
	situation() {
		// TODO: re-enable
		// this.router.post('/situation', this.asyncRoute(async (req, res) => {
	...
	file_upload() {
		// TODO: re-enable
		// this.router.post('/file_upload', this.asyncRoute((req, res) => {
