const mandatoryInstructions = [
	...
	"add field Last connection with type date",
	...
	"add field Comment with type boolean and default value false",
	"add field Reason with type boolean and default value false",
	"entity Status has many Status called Children",
	"entity Status has many Reason called Reasons",
	"select entity Reason",
	"add field Name",
	"set field Name required",
	"add field Enabled with type boolean and default value true",
	...
	"add field Media related to Media using name, type",
	"add field Order with type number",
