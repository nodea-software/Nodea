...
router.post('/update_logs', middlewares.isLoggedIn, function(req, res) {
	try {
...
router.get('/completion', middlewares.isLoggedIn, function(req, res) {
	try {
...
router.post('/ajaxtranslate', middlewares.isLoggedIn, function(req, res) {
	res.json({
