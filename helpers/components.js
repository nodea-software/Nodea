module.exports = {
	address: {
		generateFields: (addressConf, componentName, componentCodeName) => {
			const result = {
				db_fields: {
					f_address_label: {
						type: 'STRING'
			...
			<a href="#" class="info_address_map">\n\
				<i class="fa fa-info-circle"></i>\n\
			</a>\n\
			<br><br>\n\
			<section id='section_${componentCodeName}_fields' class='col-12 section_address_fields'>\n`;
			...
			if (addressConf.endpoint.enable) {
				createHtml += "		<div data-field='address_search_input' class='col-12 div_address_search_input'>\n";
				createHtml += "			<div class='form-group'>\n";
				createHtml += "				<div class='input-group'>\n";
				createHtml += "					<div class='input-group-prepend'>\n";
				createHtml += "						<span class='input-group-text'>\n";
				...
				updateHtml += "		<div data-field='address_search_input' class='col-12 div_address_search_input'>\n";
				updateHtml += "			<div class='form-group'>\n";
				updateHtml += "				<div class='input-group'>\n";
				updateHtml += "					<div class='input-group-prepend'>\n";
				updateHtml += "						<span class='input-group-text'>\n";
			...
			for (const attributeKey in addressConf.attributes) {
				...
				if (addInForm) {
					...
					let display_create = 'block',
						display_udpate = 'block',
						display_show = 'block';
					...
					createHtml += "		<div data-field='" + dbcolumn + "' class='col-12' style='display:" + display_create + "'>\n"
					createHtml += "			<div class='form-group'>\n";
					...
					createHtml += "		</div>\n";
					// Update
					updateHtml += "		<div data-field='" + dbcolumn + "' class='col-12' style='display:" + display_udpate + "'>\n"
					updateHtml += "			<div class='form-group'>\n";
					...
					updateHtml += "		</div>\n";
					// Show
					showFieldsHtml += "		<div data-field='" + dbcolumn + "' class='col-12' style='display:" + display_show + "'>\n";
